...
<nav class="navbar navbar-expand-lg">
    <a class="navbar-brand hvr-pulse-grow d-flex block items-center" href="{{ url('/') }}" wire:navigate>
        <img src="images/staking_logo.png" alt="" class="logo img-fluid" style="height: 60px; width: 60px;" />
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" style="visibility: visible !important;">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link hvr-underline-from-left" href="{{ url('/bounty') }}" wire:navigate>
                    {{ __('Bounty') }} </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link hvr-underline-from-left" href="https://t.me/dog_dev" target="_blank">
                    {{ __('Support') }}
                </a>
            </li>
