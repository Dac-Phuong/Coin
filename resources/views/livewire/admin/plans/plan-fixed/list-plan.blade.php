<div>
    ...
    <h4 class="py-3 mb-2">
        <span class="text-muted fw-light">{{ __('Plan Manage') }} /</span> {{ __('Plan Fixed') }}
    </h4>
    <div class="card">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="card-header">{{ __('List Plan Fixed') }}</h5>
            @can('create-plan')
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            @can('delete-plan')
                                                <button wire:click="delete({{ $plan->id }})" class="dropdown-item"
                                                    wire:click="delete"><i class="ti ti-trash me-1"></i> Xóa</button>
                                            @endcan
                                        </div>
                                    </div>
                                </td>
