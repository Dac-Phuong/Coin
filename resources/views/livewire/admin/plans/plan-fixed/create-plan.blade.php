                    ...
                    <div class="ecommerce-customer-add-basic">
                        ...
                        <div class="mb-3 fv-plugins-icon-container">
                            <label class="form-label"
                                for="ecommerce-customer-add-contact">{{ __('Deposit') }}*</label>
                            <input type="number" required id="ecommerce-customer-add-contact"
                                class="form-control phone-mask" placeholder="Nhập số tiền"
                                ...
                                @foreach ($inputs as $key => $input)
                                    <div class="row">
                                        <div class="mb-2 col-md-5 mb-0 " style="padding-right: 0px">
                                            <label class="form-label" for="form-repeater-1-1">Number days</label>
                                            <input type="number" required
                                                wire:model="number_days.{{ $key }}.days"
                                                id="form-repeater-1-1" class="form-control" placeholder="1 days">
                                        </div>
                                        <div class="mb-2 col-md-5 mb-0 " style="padding-right: 0px">
                                            <label class="form-label" for="form-repeater-1-1">{{ __('Profit') }}(%) *</label>
                                            <input type="number" required
                        ...
                        <div class="mb-3">
                            <label for="defaultSelect" class="form-label">Payment Type</label>
                            <select id="defaultSelect" wire:model.defer="type_date" class="form-select">
