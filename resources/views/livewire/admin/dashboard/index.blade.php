<div class="row">
    <!-- Website Analytics -->
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light">{{ __('Dashboards') }} /</span>{{ __('Statistical') }}
    </h4>
    <div class="row">
                    ...
                    <div class="col-7">
                        <div class="card-body text-nowrap">
                            ...
                            <h4 class="text-primary mb-1">
                                ${{ isset($total_amount) ? number_format($total_amount->total_amount, 2) : 0 }}</h4>
                            <button data-kt-action="update" data-id={{ $investor->id }} data-bs-toggle="modal"
                                data-bs-target="#kt_modal_update1"
                    ...
                    <div class="row gy-3">
                        <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="card-info">
                                    <h5 class="mb-0">${{ number_format($total_investment_amount, 2) ?? 0 }}</h5>
                        ...
                        <div class="col-md-3 col-6">
                            <div class="d-flex align-items-center">
                                <div class="badge rounded-pill bg-label-success me-3 p-2"><i
                                        class="ti ti-currency-dollar ti-sm"></i></div>
                                <div class="card-info">
                                    <h5 class="mb-0">${{ number_format($total_withdraw_amount, 2) ?? 0 }}</h5>
                ...
                <div class="row">
                    <div class="col-12 col-md-4 d-flex flex-column align-self-end">
                        <div class="d-flex gap-2 align-items-center mb-2 pb-1 flex-wrap">
                            <h1 class="mb-0">${{ number_format($total_profit, 2) ?? 0 }}</h1>
                ...
                <div class="border rounded p-3 mt-4">
                    <div class="row gap-4 gap-sm-0">
                        <div class="col-12 col-sm-4">
                            ...
                            <h4 class="my-2 pt-1">${{ number_format($total_profit, 2) ?? 0 }}</h4>
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            <h4 class="my-2 pt-1">${{ number_format($total_earnings, 2) ?? 0 }}</h4>
                            <div class="progress w-75" style="height: 4px">
                        ...
                        <div class="col-12 col-sm-4">
                            ...
                            <h4 class="my-2 pt-1">${{ number_format($total_expense, 2) ?? 0 }}</h4>
                            <div class="progress w-75" style="height: 4px">
                ...
                <div class="row">
                    <div class="col-12 col-sm-4 col-md-12 col-lg-4">
                        <div class="mt-lg-4 mt-lg-2 mb-lg-4 mb-2 pt-1">
                            <h1 class="mb-0">${{ number_format($total_investment_amount_in_week, 2) ?? 0 }}</h1>
                        ...
                        <ul class="p-0 m-0">
                            <li class="d-flex gap-3 align-items-center mb-lg-3 pt-2 pb-1">
                                ...
                                <div>
                                    ...
                                    <small
                                        class="text-muted">${{ number_format($total_amount_in_week_pendding, 2) ?? 0 }}</small>
                            ...
                            <li class="d-flex gap-3 align-items-center mb-lg-3 pb-1">
                                ...
                                <div>
                                    ...
                                    <small
                                        class="text-muted">${{ number_format($total_amount_in_week_running, 2) ?? 0 }}</small>
                            ...
                            <li class="d-flex gap-3 align-items-center mb-lg-3 pb-1">
                                ...
                                <div>
                                    ...
                                    <small
                                        class="text-muted">${{ number_format($total_amount_in_week_success, 2) ?? 0 }}</small>
                            ...
                            <li class="d-flex gap-3 align-items-center pb-1">
                                ...
                                <div>
                                    ...
                                    <small
                                        class="text-muted">{{ number_format($total_amount_in_week_cancel, 2) ?? 0 }}</small>
                                </div>
                            </li>
                        </ul>
                    </div>
