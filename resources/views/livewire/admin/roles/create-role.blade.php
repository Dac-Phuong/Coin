                                ...
                                <tbody>
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Administrator access') }} <i
                                                ...
                                                data-bs-original-title="{{ __('Allow full access to the system') }}"></i></td>
                                        <td>
                                            <div class="form-check">
                                                <input class="form-check-input" wire:model.live="selectAll" type="checkbox" class="check-all"
                                                    id="selectAll">
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Statistical manager') }}</td>
                                        <td>
                                            <div class="d-flex">
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Investor manager') }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Manage investment packages') }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Wallet manager') }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                    ...
                                    <tr>
                                        <td class="text-nowrap fw-medium">{{ __('Manage withdrawals') }}</td>
                                        <td>
                                            <div class="d-flex">
                                                <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                                ...
                                                {{-- <div class="form-check me-3 me-lg-5">
                                                    <input class="form-check-input" wire:model.defer="permissions"
                                                        type="checkbox" value="history-withdraw" id="reportingRead">
                                                    <label class="form-check-label" for="reportingRead">
                                                        Xem lịch sử
                                                    </label>
                                                </div> --}}
